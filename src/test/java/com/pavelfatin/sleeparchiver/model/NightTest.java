...
public class NightTest {
    @Test
    public void empty() {
        Night night = new Night(null, null, 0, null, new ArrayList<LocalTime>());
        ...
        assertThat(night.getMoments(), equalTo(Collections.<LocalTime>emptyList()));
    ...
    public void accuracy() {
        Night night = new Night(
                ...
                true,
                "foo",
                Utilities.newList(LocalTime.of(1, 2)),
                Utilities.newList("A", "B"));

        assertThat(night.getDate(), equalTo(LocalDate.of(2001, 1, 1)));
        assertThat(night.getAlarm(), equalTo(LocalTime.of(20, 0)));
        assertThat(night.getWindow(), equalTo(50));
        assertThat(night.getToBed(), equalTo(LocalTime.of(10, 0)));
        ...
        assertThat(night.getMoments(), equalTo(Utilities.newList(LocalTime.of(1, 2))));
